...
main:
    ...
    #subtract the numbers into the registers
    sub $s1, $s0, $s1
    
    #output the difference of both numbers
    li $v0, 4
    la $a0, differenceMessage
    syscall
    li $v0, 1
    move $a0, $s1
    syscall
...
differenceMessage: .asciiz "\nDifference of your two numbers is: "
